...
public final class Basics extends JavaPlugin {
	...
	private void configReadme(){
		...
		try{
			...
			lol.write("---------------------------" + newLine);
			lol.write("IMPORTANT: IT IS NOT RECOMMENDED TO EDIT THE CONFIG FILE WITH NOTEPAD, USE NOTEPAD++. (TextEdit should be fine.)" + newLine);
			lol.write("is-beta-version: " + "This controls whether or not you get the latest beta (possibly quite buggy) version of Basics." + newLine);
			lol.write("server-owners: " + "This, along with the permission 'basics.brb', control whether or not a user can do /brb . (Note: This can be a list, seperated by commas)" + newLine);
			lol.write("message: " + "A brief server description that is shown to new players who join while the brb command is active." + newLine);
			lol.write("download-latest-version: " + "This controls whether or not you will get the latest version in your /plugins/Basics/updates/ folder" + newLine);
			lol.write("teleport-requests: " + "This controls whether requests will be sent to players who do /tpr . This is the equivelant of /tpr setRequest" + newLine);
			lol.write("tag-playing-time-minutes: " + "This controls the amount of time that will pass before tag is over, and the winner(s) are declared." + newLine);
